Above terraform scripts create the same EC2 instance as basic script but written differently by using input,output variables and provider terraform scripts.
